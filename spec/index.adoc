...
本文档是对OGC GeoPackage资料库 (https://github.com/opengis/geopackage) 完整的中文翻译，便于中文传播。
除本小结（中文翻译说明）外，都基于GeoPackage规范原文忠实翻译，未对GeoPackage原文的意思做任何增、删、变动。
...
[cols="1,1a,2,2",options="header",]
|=======================================================================
|姓名 |组织 |负责章节 | Email
|曹利平 |SuperMap |1，2.1.1-2.1.4, 2.2.7-2.2.8, 2.3 | caoliping@supermap.com
|孙笑玉 |SuperMap |2.1.5-2.1.6, 2.2.1-2.2.6 | sunxiaoyu@supermap.com
|谷永权 |SuperMap |2.5 | guyongquan@supermap.com
|周世杰 |SuperMap |3.2，4 | zhoushijie@supermap.com
|苏乐乐 |SuperMap |2.4, 3.1 | sulele@supermap.com
|=======================================================================
